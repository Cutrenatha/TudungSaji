...
<body class="font-sans bg-white text-black">
  ...
  <a href="#" class="font-semibold hover:underline transition">Tips Memasak</a>
</nav>


  <!-- Judul & Deskripsi -->
  <section class="max-w-6xl mx-auto px-4 py-4 text-center">
    <h2 class="text-2xl font-bold mb-2">Tips Masak</h2>
...
<section class="max-w-6xl mx-auto px-4 py-6">
  <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
    ...
    <!-- Card -->
    <a href="https://kumparan.com/tips-dan-trik/5-cara-menggoreng-ayam-agar-empuk-dan-matang-sempurna-20xjOTYpphx" class="transform hover:scale-[1.02] transition duration-300">
      <div class="h-full rounded-xl overflow-hidden shadow-md hover:shadow-lg bg-white flex flex-col">
        <img src="tips1.png" alt="Tips 1" class="w-full h-40 object-cover">
    ...
    <a href="#" class="transform hover:scale-[1.02] transition duration-300">
      <div class="h-full rounded-xl overflow-hidden shadow-md hover:shadow-lg bg-white flex flex-col">
        <img src="tips2.png" alt="Tips 2" class="w-full h-40 object-cover">
        <div class="p-3 flex-grow flex items-end">
    ...
    <a href="#" class="transform hover:scale-[1.02] transition duration-300">
      <div class="h-full rounded-xl overflow-hidden shadow-md hover:shadow-lg bg-white flex flex-col">
        <img src="tips3.png" alt="Tips 3" class="w-full h-40 object-cover">
        <div class="p-3 flex-grow flex items-end">
    ...
    <a href="#" class="transform hover:scale-[1.02] transition duration-300">
      <div class="h-full rounded-xl overflow-hidden shadow-md hover:shadow-lg bg-white flex flex-col">
        <img src="tips4.png" alt="Tips 4" class="w-full h-40 object-cover">
        <div class="p-3 flex-grow flex items-end">
    ...
    <a href="#" class="transform hover:scale-[1.02] transition duration-300">
      <div class="h-full rounded-xl overflow-hidden shadow-md hover:shadow-lg bg-white flex flex-col">
        <img src="tips5.png" alt="Tips 5" class="w-full h-40 object-cover">
        <div class="p-3 flex-grow flex items-end">
    ...
    <a href="#" class="transform hover:scale-[1.02] transition duration-300">
      <div class="h-full rounded-xl overflow-hidden shadow-md hover:shadow-lg bg-white flex flex-col">
        <img src="tips6.png" alt="Tips 6" class="w-full h-40 object-cover">
        <div class="p-3 flex-grow flex items-end">
