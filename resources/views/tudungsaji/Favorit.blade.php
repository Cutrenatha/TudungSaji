...
<body class="font-sans bg-white text-black">
 ...
 <header class="flex items-center justify-between px-6 py-4 border-b border-orange-300 bg-[#f4c988]">
    ...
    <h1 class="text-2xl font-bold">
      Menu <span class="text-orange-600">Favorit</span>
    </h1>
    <div class="flex items-center space-x-2">
  ...
  <a href="#" class="font-semibold hover:underline transition">Favorit</a>
</nav>


  <!-- Judul Halaman -->
  <section class="max-w-6xl mx-auto px-4 py-4 text-center">
    <h2 class="text-2xl font-bold mb-2">Menu Favorit</h2>
    <p class="text-gray-600"> Temukan resep-resep pilihan yang paling kamu suka. Praktis, enak, dan jadi favorit banyak orang!

</p>
  </section>

 <!-- Grid Resep Favorit -->
<div class="px-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-20">
  <!-- Card Resep -->
  <div class="bg-[#FFF7EC] rounded-xl shadow p-3 flex flex-col h-full justify-between">
    <img src="fav1.png" alt="Spaghetti" class="rounded-lg w-full h-40 object-cover">
    <div class="mt-3">
      <div class="font-semibold">Resep Spaghetti Bolognese Simple</div>
  ...
  <div class="bg-[#FFF7EC] rounded-xl shadow p-3 flex flex-col h-full justify-between">
    <img src="fav2.png" alt="Sate" class="rounded-lg w-full h-40 object-cover">
    <div class="mt-3">
      <div class="font-semibold">Resep Sate Malang Daging Sapi Empuk dan Kaya Bumbu</div>
  ...
  <div class="bg-[#FFF7EC] rounded-xl shadow p-3 flex flex-col h-full justify-between">
    <img src="fav3.png" alt="Es Doger" class="rounded-lg w-full h-40 object-cover">
    <div class="mt-3">
      <div class="font-semibold">Resep Es Doger Super Nyegerin</div>
  ...
  <div class="bg-[#FFF7EC] rounded-xl shadow p-3 flex flex-col h-full justify-between">
    <img src="res4.png" alt="Bakso" class="rounded-lg w-full h-40 object-cover">
    <div class="mt-3">
      <div class="font-semibold">Resep Bakso Daging Kenyal</div>
