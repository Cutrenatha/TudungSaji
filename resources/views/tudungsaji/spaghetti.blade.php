...
<aside class="col-span-1 border-r border-gray-300 pr-6">
 ...
 <!-- Tombol Menulis Review -->
 <button class="w-full mt-6 bg-orange-500 hover:bg-orange-600 text-white text-sm font-semibold py-2 px-4 rounded-md shadow transition duration-200">
     Menulis Review ✍️
  </button>
</aside>
