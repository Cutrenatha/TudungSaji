...
<html lang="id">
  ...
  <body class="bg-orange-100 font-inter">
    ...
    <nav class="bg-orange-200 p-4 flex justify-between items-center">
      ...
      <div class="flex space-x-6 items-center">
        <a href="#" class="text-black font-medium hover:text-orange-600 hover:underline underline-offset-4 transition-all duration-200">Beranda</a>
        <a href="#" class="text-black font-medium hover:text-orange-600 hover:underline underline-offset-4 transition-all duration-200">Resep Masakan</a>
        <a href="#" class="text-black font-medium hover:text-orange-600 hover:underline underline-offset-4 transition-all duration-200">Tips Masak</a>
        <a href="#about-us" class="hover:text-orange-500 transition">Tentang Kami</a>
    ...
    <div class="bg-white rounded-lg shadow-lg p-6 w-[90%] max-w-md relative">
        <button id="closePopup" class="absolute top-2 right-2 text-orange-500 text-2xl font-bold">&times;</button>
  ...
  favoritBtn.addEventListener('click', (e) => {
    e.preventDefault();
...
<section class="px-6 py-12 bg-[#F9F5F0]">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
    <!-- 1 -->
    <div class="bg-[#F4F0E5] rounded-xl p-3 shadow hover:shadow-md relative transition-transform duration-200 hover:scale-105 active:scale-95">
      <img src="beranda1.png" alt="Dimsum" class="rounded-lg w-full h-40 object-cover mb-3" />
      <div class="absolute bottom-3 right-3 flex space-x-2">
        <button>
          <svg class="w-5 h-5 text-gray-700 hover:text-black" fill="none" stroke="currentColor" stroke-width="2"
            viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round"
      ...
      <h3 class="text-sm font-semibold mb-1 leading-snug">Resep Dimsum Mentai Enak Yang Cocok Untuk Jualan</h3>
    ...
    <!-- 7 -->
    <div class="bg-[#F4F0E5] rounded-xl p-3 shadow hover:shadow-md relative transition-transform duration-200 hover:scale-105 active:scale-95">
      <img src="beranda7.png" alt="Sambal Matah" class="rounded-lg w-full h-40 object-cover mb-3" />
      <div class="absolute bottom-3 right-3 flex space-x-2">
        <button>
          <svg class="w-5 h-5 text-gray-700 hover:text-black" fill="none" stroke="currentColor" stroke-width="2"
            viewBox="0 0 24 24">
      ...
      <h3 class="text-sm font-semibold mb-1 leading-snug">Resep Sambal Matah Enak yang Wanginya Sampai Satu Rumah</h3>
      <p class="text-xs text-gray-700">Oleh Nadia Maghda</p>
    </div>

    <!-- 8 -->
    <div class="bg-[#F4F0E5] rounded-xl p-3 shadow hover:shadow-md relative transition-transform duration-200 hover:scale-105 active:scale-95">
      <img src="beranda8.png" alt="Es Campur" class="rounded-lg w-full h-40 object-cover mb-3" />
      <div class="absolute bottom-3 right-3 flex space-x-2">
        <button>
          <svg class="w-5 h-5 text-gray-700 hover:text-black" fill="none" stroke="currentColor" stroke-width="2"
            viewBox="0 0 24 24">
      ...
      <h3 class="text-sm font-semibold mb-1 leading-snug">Resep Es Campur Mutiara Kuah Santan Bikin Ketagihan!</h3>
...
<?php /*PATH /Users/rayshatazkiyarahim/Documents/TudungSaji/resources/views/pages/beranda.blade.php ENDPATH*/ ?>
