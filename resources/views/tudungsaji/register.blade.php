      ...
      <form class="space-y-4">
        ...
        <div class="flex gap-4">
          <div class="w-1/2">
            ...
            <input type="text" class="w-full px-4 py-2 bg-orange-100 rounded-md focus:outline-none" />
          </div>
          <div class="w-1/2">
        ...
        <div>
          ...
          <input type="email" class="w-full px-4 py-2 bg-orange-100 rounded-md focus:outline-none" />
        </div>

        <!-- Password -->
        <div>
          <label class="block text-sm font-medium mb-1">Password</label>
          <input type="password" class="w-full px-4 py-2 bg-orange-100 rounded-md focus:outline-none" />
        </div>
       ...
       <!-- Register Button -->
          <div class="text-center pt-4">
            <a href="/login" class="block w-full bg-orange-500 hover:bg-orange-600 text-white py-2 px-4 rounded-md font-semibold text-center">
              REGISTER
            </a>
          </div>
        ...
        <p class="text-center text-sm mt-4 text-gray-600">
          ...
          <a href="/login" class="text-orange-500 hover:underline">Sign in</a>
        </p>
      </form>
    </div>
  </div>
